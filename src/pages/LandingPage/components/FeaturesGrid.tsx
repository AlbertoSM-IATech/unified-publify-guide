        ...
        >
          {features.map((feature, index) => (
            <motion.div 
              ...
              whileHover="hover"
              className="card-hover group rounded-lg border bg-card p-6 shadow-sm relative overflow-hidden backdrop-blur-sm"
            >
              ...
              {/* Icon with animation */}
              <motion.div 
                className="mb-4 rounded-full bg-gradient-to-br from-primary/10 to-[#FB923C]/10 p-3 text-primary group-hover:bg-[#FB923C] group-hover:text-primary-foreground transition-colors relative z-10"
              ...
              <motion.div 
                className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-primary to-[#FB923C] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300"
              />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          ...
          >
            <Button 
              ...
              className="bg-[#FB923C] hover:bg-[#FB923C]/90 hover:shadow-lg hover:shadow-[#FB923C]/20"
              size="lg"
            >

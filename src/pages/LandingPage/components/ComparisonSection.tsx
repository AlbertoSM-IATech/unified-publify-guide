...
export const ComparisonSection = () => {
  return (
    <section className="py-24 bg-muted dark:bg-secondary/40 border-y border-border/50 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-destructive/5 via-transparent to-accent/5 dark:from-destructive/5 dark:to-accent/5 pointer-events-none" />

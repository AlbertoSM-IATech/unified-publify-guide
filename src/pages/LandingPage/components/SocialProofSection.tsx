...
const stats = [{
  icon: Users,
  value: "500+",
  label: "Publishers activos"
}, {
  icon: BookOpen,
  value: "3,200+",
  label: "Libros gestionados"
}, {
  icon: Clock,
  value: "8h",
      ...
      <div className="container mx-auto px-4">
        ...
        <ScrollReveal variant="zoom" duration={0.8}>
          <div className="max-w-4xl mx-auto text-center mb-16">
            <blockquote className="bg-card border border-border rounded-2xl p-8 md:p-12 shadow-lg">
              ...
              <p className="text-2xl md:text-3xl font-medium text-foreground mb-6 leading-relaxed">"Por fin tenemos todo en un mismo sitio. Menos horas de caos, más horas de creación."</p>
        ...
        <div className="mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {stats.map((stat, index) => <ScrollReveal key={index} variant="slide-up" delay={index * 0.1} duration={0.5}>
        ...
        <ScrollReveal variant="fade" delay={0.2}>
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {quickTestimonials.map((testimonial, index) => <ScrollReveal key={index} variant="rotate" delay={index * 0.15} duration={0.6}>

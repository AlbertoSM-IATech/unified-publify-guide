          ...
          <ScrollReveal variant="fade" duration={0.8}>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-6">
              ...
              <div className="text-lg text-muted-foreground max-w-3xl mx-auto space-y-4 text-left">
                ...
                <p>Y cuando por fin lo entiendes, ya estás atrapado en mil herramientas sueltas:</p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              <ScrollReveal variant="slide-left" delay={0.2}>
                <h3 className="text-primary mb-6 text-center md:text-center text-3xl font-normal">Publify: un solo sitio para gestionarlo todo</h3>

      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          once: true
            ...
            <h3 className="text-2xl font-bold mb-8 text-red-600 dark:text-red-400">El caos editorial actual</h3>
            <div className="space-y-6">
              {timeWasters.map((point, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
          ...
          once: true
            ...
            <h3 className="text-2xl font-bold mb-8 text-green-600 dark:text-green-400">Publify: Un cambio de sistema</h3>
            <div className="space-y-6">
              {solutionPoints.map((point, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
        ...
        once: true
          ...
          <Button size="lg" onClick={() => navigate("/register")} className="bg-[#FB923C] hover:bg-[#FB923C]/90 px-8 py-6 text-lg">

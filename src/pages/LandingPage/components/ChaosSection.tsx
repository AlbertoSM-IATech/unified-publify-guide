...
export const ChaosSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute inset-0 bg-gradient-to-b from-background to-muted/40 -z-10"
      ...
      <div className="absolute inset-0 -z-10 opacity-10 pointer-events-none">
        {[...Array(5)].map((_, i) => (
          <motion.div 
            key={i}
            className="absolute rounded-full bg-[#FB923C]/30" 
            initial={{ 
              x: `${Math.random() * 100}%`, 
              y: `${Math.random() * 100}%`,
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          {[
            ...
            <motion.div 
              ...
              whileHover="hover"
              className="rounded-lg border bg-card p-6 shadow-sm backdrop-blur-sm"
            >
              <div className="mb-4 rounded-full bg-[#FB923C]/20 p-3 w-12 h-12 flex items-center justify-center text-[#FB923C]">
                {index + 1}
              </div>
        ...
        >
          ...
          >
            <Button 
              className="group bg-[#FB923C] hover:bg-[#FB923C]/90 shadow-lg shadow-[#FB923C]/20"
              size="lg"

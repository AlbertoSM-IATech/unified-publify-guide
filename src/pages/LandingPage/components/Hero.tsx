      ...
      <div className="mx-auto max-w-4xl text-center relative">
        ...
        >
          ...
          <span className="relative inline-block">
            <span className="text-primary">KDP</span>
            <motion.span 
        ...
        >
          <motion.div variants={buttonHoverVariants} whileHover="hover">
            <Button 
              ...
              className="group text-base px-8 py-6 bg-gradient-to-r from-primary to-[#FB923C] hover:shadow-lg hover:shadow-primary/20"
              size="lg"
            >
          ...
          <motion.div variants={buttonHoverVariants} whileHover="hover">
            <Button 
              ...
              onClick={handleLogin}
              size="lg"
              className="text-base px-8 py-6 border-[#FB923C]/30 hover:border-[#FB923C]/80 hover:bg-[#FB923C]/10"
            >

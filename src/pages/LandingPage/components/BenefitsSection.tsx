      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          {benefits.map((benefit, index) => (
            <motion.div 
              key={index} 
              className="rounded-lg border bg-card p-6 shadow-sm hover:shadow-md transition-all relative backdrop-blur-sm"
            ...
            >
              ...
              <motion.div 
                className="absolute bottom-0 left-0 w-full h-[3px] bg-gradient-to-r from-primary to-[#FB923C] origin-left"
                initial={{ scaleX: 0 }}

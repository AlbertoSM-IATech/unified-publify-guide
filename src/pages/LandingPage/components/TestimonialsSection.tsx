...
export const TestimonialsSection = () => {
  ...
  return (
    <motion.section 
      ref={ref}
      className="relative py-20 px-4 overflow-hidden bg-muted/20"
    >
      ...
      <div className="container mx-auto">
        ...
        >
          <div className="flex justify-center mb-4">
            <motion.div 
              className="rounded-full bg-[#FB923C]/10 p-3 text-[#FB923C]"
              initial="initial"
              whileInView="animate"
              viewport={{ once: true }}
        ...
        >
          ...
          >
            <Button 
              ...
              className="bg-gradient-to-r from-primary to-[#FB923C] hover:shadow-lg px-6 py-2"
            >
              Únete a ellos
              <motion.div
                className="ml-2"
...
const TestimonialCard = ({ testimonial }: TestimonialCardProps) => (
  <ContentCard 
    className="h-full bg-background border shadow-sm backdrop-blur-sm"
  ...
  >
    ...
    <motion.div 
      className="flex items-center justify-center gap-3 pt-4 mt-auto border-t"

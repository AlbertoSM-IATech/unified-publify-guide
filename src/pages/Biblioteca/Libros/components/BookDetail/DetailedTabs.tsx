...
import { Info, BookOpen, FileText, Link, Calendar, CircleDollarSign } from "lucide-react";
      ...
      <Tabs defaultValue="info" className="space-y-4">
        <Card className="p-1 shadow-md overflow-hidden border border-slate-200 dark:border-slate-700">
          <TabsList className="grid grid-cols-3 md:grid-cols-3 w-full bg-transparent">
            <TabsTrigger value="info" className="data-[state=active]:text-[#FB923C] data-[state=active]:shadow-[0_1px_0_0_#FB923C] font-semibold">
              <div className="flex items-center gap-2">
                <Info size={16} />
                <span className="hidden md:block">Información</span>
              </div>
            </TabsTrigger>
            <TabsTrigger value="formats" className="data-[state=active]:text-[#FB923C] data-[state=active]:shadow-[0_1px_0_0_#FB923C]">
              <div className="flex items-center gap-2">
                <BookOpen size={16} />
                <span className="hidden md:block">Formatos</span>
              </div>
            </TabsTrigger>
            <TabsTrigger value="notes" className="data-[state=active]:text-[#FB923C] data-[state=active]:shadow-[0_1px_0_0_#FB923C]">
              <div className="flex items-center gap-2">
                <FileText size={16} />

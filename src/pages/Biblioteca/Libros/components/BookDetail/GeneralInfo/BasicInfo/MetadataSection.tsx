        ...
        {isEditing ? (
          ...
          <div className="flex items-center gap-2">
            <a 
              ...
              className="text-[#3B82F6] hover:text-[#FB923C] hover:underline flex items-center gap-1 border rounded-md p-2 bg-card shadow-sm flex-grow"
            >

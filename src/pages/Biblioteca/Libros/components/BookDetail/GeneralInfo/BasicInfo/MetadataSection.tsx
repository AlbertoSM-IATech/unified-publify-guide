...
export const MetadataSection = ({
  ...
  return <div className="space-y-6 mt-8">
      <div className="flex items-center">
        <h3 className="text-lg font-extrabold text-blue-500">Enlaces</h3>
      ...
      <div className="grid gap-3">
        ...
        field
                ...
                <FormControl>
                  <Input id="bsr" placeholder="Ranking de ventas (p. ej. 12345)" type="number" {...field} value={field.value || ''} onChange={e => field.onChange(e.target.value ? parseInt(e.target.value) : null)} />
                </FormControl>
              </FormItem>} /> : <div className="border rounded-md p-2 bg-card shadow-sm">
            {book.bsr ? `#${book.bsr}` : "No disponible"}
          </div>}
      </div>
      ...
      <div className="grid gap-3">
        ...
        field
              ...
              </FormItem>} /> : book.landingPageUrl ? <div className="flex items-center gap-2">
          ...
          </div> : <div className="border rounded-md p-2 bg-card shadow-sm">
            No definida
          </div>}
      </div>
    </div>;

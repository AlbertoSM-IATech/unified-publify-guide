...
export const Dashboard = () => {
  ...
  return <div className="p-4 animate-fade-in space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card className="overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gray-900 py-[30px]">
            <div className="space-y-1">
              <CardTitle className="text-lg font-medium flex items-center gap-2">
          ...
          <CardContent className="pb-4 bg-zinc-900 py-[20px] px-[50px]">
            <div className="h-[350px]">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="pb-4 bg-zinc-900 px-0 my-0 mx-0 py-[33px]">
            <div className="h-[350px]">

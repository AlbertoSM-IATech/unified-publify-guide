      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="pb-4 bg-zinc-900">
            <div className="h-[350px]">
              <PieChartCard title="Distribución por Estado" description="Proporción de libros según su estado de publicación" data={pieChartData} chartConfig={CHART_CONFIG} totalLabel="Total libros" totalValue={2} />
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent className="my-[31px]">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            {[1, 2].map(index => <BookCard key={index} index={index} />)}
          </div>
        </CardContent>
      </Card>
    </div>;
